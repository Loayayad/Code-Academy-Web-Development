(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var _homeCcuserBabelscriptsReactTransformComponentExports2 = (0, _reactTransformComponentExports2.default)({
      filename: '/home/ccuser/workspace/react-102-mounting-lifecycle-methods-componentdidmount/Flashy.js',
    ...
    var Flashy = exports.Flashy = _wrapComponent('Flashy')(function (_React$Component) {
      _inherits(Flashy, _React$Component);
    
      function Flashy() {
        _classCallCheck(this, Flashy);
    
        return _possibleConstructorReturn(this, (Flashy.__proto__ || Object.getPrototypeOf(Flashy)).apply(this, arguments));
      }
    ...
    _reactDom2.default.render(_react3.default.createElement(Flashy, { color: 'red' }), document.getElementById('app'));
    
    setTimeout(function () {
      _reactDom2.default.render(_react3.default.createElement(Flashy, { color: 'green' }), document.getElementById('app'));
    }, 2000);
